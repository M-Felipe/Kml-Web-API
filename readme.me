...
5. A API estará rodando em http://localhost:5000 ou outro URL:PORTA configurado.
  Estarei utilizando o swagger então minha URL é http://localhost:5259/swagger/index.html

## Endpoints
### Exportar Novo Arquivo KML
...
- **Resposta**:
  - Retorna o arquivo KML filtrado como um download.
